...
struct CyclicPermutation {
    ...
    static func getNumberOfCycles(adjList: [Int]) -> Int {
    ...
    static func printNumOfCycles(_ adjList: [Int]){
        let count = getNumberOfCycles(adjList: adjList)
        print("adjList", adjList, count)
    }

    static func isCycle(_ adjList: [Int], _ visited: inout [Bool], _ cycle: inout [Bool], _ from: Int) -> Bool {
        // base case
